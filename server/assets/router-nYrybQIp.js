...
const appCss = "/assets/styles-DECvuLAy.css";
...
const $$splitComponentImporter = () => import("./index-HCqnFhq6.js").then((n) => n.i);
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Create a beautiful traditional marriage biodata. Add, edit, and remove fields, attach a photo, and export to PDF."
    }]
  })
});
